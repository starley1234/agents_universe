...
- [x] Schema-aware MCP argument normalization для внешних tools: path→code/source/content, defaults, enum values, required validation, OpenSCAD render alias resolution, validation-error detection.
