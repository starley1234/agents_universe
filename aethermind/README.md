...
- schema-aware MCP argument normalization: если внешний tool требует `code`, а агент дал `path`, runtime подставит содержимое файла; также заполняются defaults/enum values;
